...
public class CabController {
	...
	public List<CabDTO> viewCabByType(@PathVariable String cabType) 
	{
		return cabService.viewCabByType(cabType);
	}
	
	@GetMapping("/viewByLocation/{currentLocation}")
	public List<CabDTO> viewCabByCurrentLocation(@PathVariable String currentLocation)
	{
		return cabService.viewCabByCurrentLocation(currentLocation);
	}
	
	@GetMapping("/viewCabById/{cabId}")
	public CabDTO viewCabById(@PathVariable int cabId) 
	{
		return cabService.viewCabById(cabId);
	}
	
	@GetMapping("/viewByTypeAndLoc/{cabType}/{currentLocation}")
	public List<CabDTO> viewCabByTypeAndLocation(@PathVariable String cabType,@PathVariable String currentLocation) 
	{
	...
	public CabDTO viewCabByDriverId(@PathVariable int driverId)
	{
